...
var Request = function Request(consumer_key, baseUrl, host) {
	this._configure(consumer_key, baseUrl, host);
};

Request.prototype._configure = function(consumer_key, baseUrl, host) {
